...
class App2 extends JPanel implements ActionListener {
    // Declara el triangulo y los puntos

    private Punto p1 = new Punto(50, 50, 50);
    private Punto p2 = new Punto(150, 50, 50);
    private Punto p3 = new Punto(150, 150, 50);
    private Punto p4 = new Punto(50, 150, 50);
    ...
    public void paint(Graphics g) {
        ...
        switch (this.option) {
            ...
            case 2:
                ...
                // g.drawLine(p1.x, p1.z, p2.x, p2.z);
                // g.setColor(Color.RED);
                // g.drawLine(p2.x, p2.z, p3.x, p3.z);
                // g.setColor(Color.YELLOW);
                // g.drawLine(p3.x, p3.z, p4.x, p4.z);
            ...
            case 3:
                ...
                g.drawLine(p1.y, p1.z, p2.y, p2.z);
                g.drawLine(p2.y, p2.z, p3.y, p3.z);
                g.drawLine(p3.y, p3.z, p4.y, p4.z);
                g.drawLine(p4.y, p4.z, p1.y, p1.z);
                // g.drawLine(p3.y, p3.z, p4.y, p4.z);
                break;
            case 4:
